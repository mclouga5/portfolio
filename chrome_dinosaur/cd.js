import Player from "/chrome_dinosaur/player.js";
import Ground from "/chrome_dinosaur/road.js";
import CactiController from "/chrome_dinosaur/cacti_controller.js";
import Score from "/chrome_dinosaur/score.js";

const canvas = document.getElementById("game");
const ctx = canvas.getContext("2d");

const GAME_SPEED_START = 0.7; // 1.0
...
function showStartGameText() {
  ...
  const y = canvas.height / 2;
  ctx.fillText("Press down to start!", x, y);
}
